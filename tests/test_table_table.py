...
def test_table_8_prefixing():
    ...
    _do_duplicate_label_prefixing('./tests/data/table_example8.csv', './tests/data/table_example8b.csv')


def test_table_9_prefixing():
    """Prefixing in row header"""
    _do_duplicate_label_prefixing('./tests/data/table_example9.csv', './tests/data/table_example9b.csv')


def test_table_10_prefixing():
    """Prefixing will destroy the labelling"""
    _do_duplicate_label_prefixing('./tests/data/table_example10.csv', './tests/data/table_example10b.csv')


def test_table_11_prefixing():
    """Prefixing is not performed, column header"""
    _do_duplicate_label_prefixing('./tests/data/table_example11.csv', './tests/data/table_example11b.csv')


def test_table_12_prefixing():
    """Prefixing is not performed, row header"""
    _do_duplicate_label_prefixing('./tests/data/table_example12.csv', './tests/data/table_example12b.csv')
